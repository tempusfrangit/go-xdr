...
// Source: /Users/m/skratch/go-xdr/codegen_xfile_test.go
// Generated: 2025-07-12T18:19:56-07:00
...
for i := range v.Items {
	if err := v.Items[i].Encode(enc); err != nil {
	return fmt.Errorf("failed to encode Items[i]: %w", err)
}
}
...
for i := range v.Items {
	...
	return fmt.Errorf("failed to decode Items[i]: %w", err)
}
}
