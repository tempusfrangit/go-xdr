...
// Generated: 2025-07-18T16:26:29-07:00
...
func (v *BenchmarkCompany) Encode(enc *xdr.Encoder) error {
	...
	for _, elem := range v.Employees {
		...
		// Element type BenchmarkPerson - delegate to element's Encode method if available
...
func (v *BenchmarkCompany) Decode(dec *xdr.Decoder) error {
	...
	for i := range v.Employees {
		...
		// Element type BenchmarkPerson - delegate to element's Decode method if available
